...
<title>F&R Fliesenfachgeschäft Impressum</title>
</head>
<body>
...
<div class="intro-body">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-md-8">
				<h1 class="brand-heading">F&R Fliesenfachgeschäft</h1>
	...
	<div class="row">
		<div class="col-md-8">
         ...
         <p><img src="../img/Logo2.jpg"></p>
            <br>
			<p>Telefon: +49 176 70061498 <br>
			   Telefax: +49 621 31898-94</p>

            <p>E-Mail: FR-Fliesenfachgeschäft@gmx.de <br>
			 Internet: www.fr-fliesenfachgeschäft.de</p>
			 
			 <p>Zuständige Kammer:
				Handwerkskammer Mannheim, B1 1-2, 68159 Mannheim <br>
				Berufsbezeichnung:
				Fliesen- Platten und Mosaikleger Meisterbetrieb
				</p>
				<br><br>
				
				<h3>Haftungsausschluss</h3>
				<pr>Haftung für Inhalte Als Diensteanbieter sind wir gemäß § 7 Abs.1
					...
					diese Inhalte umgehend entfernen. Haftung für Links Unser Angebot
					...
					werden wir derartige Inhalte umgehend entfernen.</pr>
